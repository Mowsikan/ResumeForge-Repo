  ...
  <div className="h-full w-full text-xs font-sans bg-white p-6">
    {visibleFields.fullName && (
      <div className="text-center mb-6">
        ...
        <div className="flex flex-wrap justify-center items-center gap-x-2 gap-y-1 text-gray-600 text-xs mt-2 px-4">
          {visibleFields.email && data.email && <span>{data.email}</span>}
          {visibleFields.phone && data.phone && data.email && <span className="text-gray-300">•</span>}
          {visibleFields.phone && data.phone && <span>{data.phone}</span>}
          {visibleFields.location && data.location && (data.email || data.phone) && <span className="text-gray-300">•</span>}
          {visibleFields.location && data.location && (
            <span>{data.location}</span>
          )}
        </div>
        <div className="flex flex-wrap justify-center items-center gap-x-2 gap-y-1 text-blue-600 text-xs mt-1 px-4">
          {visibleFields.website && data.website && (
            <span>{data.website}</span>
          )}
          {visibleFields.linkedin && data.linkedin && data.website && <span className="text-gray-400">•</span>}
          {visibleFields.linkedin && data.linkedin && (
            <span>{data.linkedin}</span>
          )}
          {visibleFields.github && data.github && (data.website || data.linkedin) && <span className="text-gray-400">•</span>}
      ...
      {visibleFields.achievements && data.achievements?.length > 0 && (
        <div>
          ...
          <div className="bg-green-50 p-3 rounded space-y-2">
            {data.achievements.map((achievement, i) => (
              <div key={i} className="text-gray-700 text-xs flex items-start gap-2">
                <span className="shrink-0 mt-0.5">•</span>
                <span data-text className="flex-1">{achievement}</span>
              </div>
            ))}
          </div>
        </div>
            ...
            <div className="space-y-2">
              {data.education.map((edu, i) => (
                <div key={i} className="bg-gray-50 p-2 rounded">
                  ...
                  <div className="text-gray-600 text-xs flex items-center gap-1.5 mt-0.5">
                    <span>{edu.year}</span>
                    {edu.grade && (
                      <>
      ...
      {visibleFields.achievements && data.achievements?.length > 0 && (
        <div className="border border-green-400 p-4 rounded bg-black/30">
          ...
          <div className="space-y-1.5">
            {data.achievements.map((achievement, i) => (
              <div key={i} className="text-green-400 text-xs flex items-start gap-2">
            ...
            <div className="space-y-2">
              {data.education.map((edu, i) => (
                <div key={i}>
                  ...
                  <div className="text-green-400 text-xs flex items-center gap-2 mt-0.5">
                    <span>{edu.year}</span>
                    {edu.grade && (
                      <>
  ...
  <div className="h-full w-full text-xs font-sans bg-white p-8 border border-gray-300">
    {visibleFields.fullName && (
      <div className="mb-8">
        ...
        <div className="flex flex-wrap items-center gap-x-3 text-gray-600 text-xs">
          {visibleFields.email && data.email && <span>{data.email}</span>}
          {visibleFields.phone && data.phone && data.email && <span className="text-gray-300 font-light">|</span>}
          {visibleFields.phone && data.phone && <span>{data.phone}</span>}
          {visibleFields.location && data.location && (data.email || data.phone) && <span className="text-gray-300 font-light">|</span>}
          {visibleFields.location && data.location && (
            <span>{data.location}</span>
          )}
        </div>
        <div className="flex flex-wrap items-center gap-x-3 text-gray-600 text-xs mt-1">
          {visibleFields.website && data.website && <span>{data.website}</span>}
          {visibleFields.linkedin && data.linkedin && data.website && <span className="text-gray-300 font-light">|</span>}
          {visibleFields.linkedin && data.linkedin && (
            <span>{data.linkedin}</span>
          )}
          {visibleFields.github && data.github && (data.website || data.linkedin) && <span className="text-gray-300 font-light">|</span>}
          {visibleFields.github && data.github && <span>{data.github}</span>}
        </div>
    ...
    <div className="space-y-6">
      ...
      {visibleFields.achievements && data.achievements?.length > 0 && (
        <div>
          ...
          <div className="space-y-1.5">
            {data.achievements.map((achievement, i) => (
              <div key={i} className="text-gray-700 text-xs flex items-start gap-2 leading-relaxed">
                <span className="shrink-0 font-bold">•</span>
                <span className="flex-1">{achievement}</span>
              </div>
            ))}
    ...
    <div className="space-y-5">
      ...
      {visibleFields.achievements && data.achievements?.length > 0 && (
        <div>
          ...
          <div className="bg-gray-50 p-3 border border-gray-200 space-y-2">
            {data.achievements.map((achievement, i) => (
              <div key={i} className="text-gray-700 text-xs leading-relaxed text-justify flex items-start gap-2">
                <span className="shrink-0 mt-0.5">•</span>
                <span className="flex-1">{achievement}</span>
              </div>
            ))}
